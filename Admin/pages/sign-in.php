          ...
          <div class="container-fluid pe-0">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
                ...
                <li class="nav-item">
                  <a class="nav-link me-2" href="https://sachinuthpala.netlify.app/">
                    <i class="fa fa-user opacity-6 text-dark me-1"></i>
                    Portfilio
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-2" href="https://github.com/SachinUthpala">
              ...
              <li class="nav-item d-flex align-items-center">
                <a class="btn btn-round btn-sm mb-0 btn-outline-primary me-2" target="_blank" href="https://sachinuthpala.netlify.app/">Web Developer</a>
              </li>
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="https://sachinuthpala.netlify.app/" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-dark">Contact Now</a>
                </li>
              </ul>
            </div>
          </div>
